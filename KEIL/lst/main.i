...
# 348 "../../../../Library/Device/Nuvoton/M031/Include/M031Series.h"
//=============================================================================
...
//AHBCLK
# 322 "../../../../Library/StdDriver/inc\\clk.h"
//APBCLK0
# 415 "../../../../Library/StdDriver/inc\\clk.h"
//APBCLK1
...
# 33 "../../../../Library/StdDriver/inc\\fmc.h"
...
void SYS_Init(void)
{
    ...
    ((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->PCLKDIV = ((0x1UL<<(0)) | (0x1UL<<(4)));


// ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPA_MFPL = (((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPA_MFPL & ~((0xful << (0)) | (0xful << (4)) | (0xful << (8)))) |
// ((0x00UL<<(0)) | (0x00UL<<(4)) | (0x00UL<<(8)));

//
// GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) )), ((0x00000001UL) ///< Bit 0 mask of an 32 bit integer | (0x00000002UL) ///< Bit 1 mask of an 32 bit integer | (0x00000004UL) ///< Bit 2 mask of an 32 bit integer), 0x1UL);
...
{
     int i;
   for( i=0;i<z;i++) { __builtin_arm_nop(); }
}

void delay_ms(unsigned int milliseconds) {
    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD = (48000 * milliseconds) - 1; // Load the number of clock cycles for the desired milliseconds
    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL = 0; // Clear the current value register
    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL = (1UL << 2U) | (1UL ); // Start the timer

    while((((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL & (1UL << 16U)) == 0); // Wait until the COUNTFLAG is set

    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL = 0; // Stop the timer
}
