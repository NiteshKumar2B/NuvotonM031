...
void SendChar_ToUART(int ch)
{
    ...
    ((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->DAT = (uint32_t)ch;
}
...
# 449 "../../../../Library/StdDriver/src/retarget.c"
    while (1)
    {
        if ((((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->FIFOSTS & (0x1ul << (14))) == 0U)
        {
            return ((char)((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->DAT);
        }
    }
...
int kbhit(void)
{
    return !((((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->FIFOSTS & (0x1ul << (14))) == 0U);
}
# 487 "../../../../Library/StdDriver/src/retarget.c"
int IsDebugFifoEmpty(void)
{
    return ((((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->FIFOSTS & (0x1ul << (28))) != 0U);
}
